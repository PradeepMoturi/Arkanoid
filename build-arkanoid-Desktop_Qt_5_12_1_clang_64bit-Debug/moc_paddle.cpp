...
QT_MOC_LITERAL(1, 7, 9), // "stop_game"
...
void Paddle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->stop_game(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Paddle::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Paddle::stop_game)) {
                *result = 0;
                return;
            }
        }
